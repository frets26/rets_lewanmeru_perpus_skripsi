...
<div class="content-wrapper">
  <section class="content-header">
    <h1 style="color:black;">
      <i class="fa fa-plus" style="color:black;"> Tambah User</i> 
    </h1 >
  </section>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lahir" required="required" placeholder="Contoh : Ambon">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="date" class="form-control" name="tgl_lahir" required="required" placeholder="Contoh : 2000-05-18">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" name="telepon" required="required" placeholder="Contoh : 081243011792">
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input type="email" class="form-control" name="email" required="required" placeholder="Contoh : Frets@gmail.com">
                                </div>
                                <div  class="form-group">
