...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-edit" style="color:black;">Update User </i>  - <?= $user->nama;?>
    </h1>
  </section>
                ...
                <div class="box-body">
                    <form action="<?php echo base_url('user/upd');?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="pull-right" >
                            <button type="submit" style="color:black;"class="btn btn-primary btn-md" style="color:black;">Edit Data</button> 
                        </form>
                        <?php if($this->session->userdata('level') == 'Petugas'){?>
