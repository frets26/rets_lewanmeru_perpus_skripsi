...
<head>
  ...
  <title><?php echo $title_web;?> | Sistem Informasi Perpustakaan SMP PGRI Kaiwatu</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-mini"><b>P</b>SPK</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">SMP PGRI Kaiwatu</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
           ...
           <i class="fa fa-edit"> </i> <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
          </li>
          <li>
