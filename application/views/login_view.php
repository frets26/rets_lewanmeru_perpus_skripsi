...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bg.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body"  style="border:15px solid #5a5a5a;">
    <p class="login-box-msg" style="font-size:10px;"></p>
  <div class="login-logo">
    <a href="index.php" style="color: gray;"><b>Perpustakaan</b><br/><b>SMP PGRI Kaiwatu</b> </a>
  </div>
