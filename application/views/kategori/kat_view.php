...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i style="color:black;"class="fa fa-edit" style="color:green"> </i>  <?= $title_web;?>
    </h1>
  </section>
					...
					<div class="box">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<button type="submit"  class="btn btn-primary"style="color:black;"><i class="fa fa-edit"></i> Edit Kategori</button>
							</form>
							<?php }else{?>
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<button type="submit" class="btn btn-primary"style="color:black;"> <i class="fa fa-plus"></i> Tambah Kategori</button>
							</form>
							<?php }?>
						</div>
					</div>
							...
							<table id="example1" class="table table-bordered table-striped table" width="100%">
								<thead>
									<tr>
										...
										<th bgcolor="gray " style="color: white;">Kategori</th>
								...
								<?php $no=1;foreach($kategori->result_array() as $isi){?>
									<tr>
										...
										<td style="width:20%;">
											<a href="<?= base_url('data/kategori?id='.$isi['id_kategori']);?>"><button class="btn btn-success"><i style="color:black;"class="fa fa-edit"></i>Edit</button></a>
