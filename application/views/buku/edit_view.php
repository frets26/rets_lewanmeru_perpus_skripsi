                ...
                <div class="box-body">
                    <form action="<?php echo base_url('data/prosesbuku');?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                ...
                                <label>Lampiran Buku <small style="color:green">(pdf) * ganti opsional</small></label>
                                    ...
                                    <a href="<?= base_url('assets_style/image/buku/'.$buku->lampiran);?>" class="btn btn-primary btn-md" target="_blank">
                                        <i class="fa fa-download"  style="color:black">Sample Buku</i> 
                                    </a>
                                    <?php  }else{ echo '<br/><p style="color:red">* Tidak ada Lampiran</p>';}?>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan Lainnya</label>
                                    <textarea class="form-control"><?= $buku->isi;?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-primary btn-md"  style="color:black" >Submit</button> 
                    </form>
                            <a href="<?= base_url('data');?>" class="btn btn-danger btn-md" style="color:black">Kembali</a>
                        </div>
                </div>
            </div>
        </div>
