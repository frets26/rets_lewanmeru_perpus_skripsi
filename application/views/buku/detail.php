					...
					<table class="table table-striped table-bordered">
						...
						<tr>
							...
							<td>
								...
								?> 
								<a data-toggle="modal" data-target="#TableAnggota" style="color:black;"class="btn btn-primary btn-xs" style="margin-left:1pc;">
									<i class="fa fa-sign-in style	" style="	color:black;">Detail Pinjam</i> </a>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php if(!empty($buku->lampiran !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->lampiran);?>" style="color:black;"class="btn btn-primary btn-md" target="_blank">
										<i style="color:black;"class="fa fa-download"></i> Sample Buku
									</a>
...
<table id="example1" class="table table-bordered table-striped">
	<thead>
		<tr>
			...
			<th bgcolor="gray" style="color: white;">Tgl Pinjam</th>
			<th bgcolor="gray" style="color: white;">Lama Pinjam</th>
		</tr>
	</thead>
	<tbody>
	<?php 
