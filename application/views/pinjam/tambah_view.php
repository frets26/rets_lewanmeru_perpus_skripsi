                    ...
                    <form action="<?php echo base_url('transaksi/prosespinjam');?>" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-5">
								<table class="table table-striped">
									<tr style="background:blue;">
										<td colspan="3" style="color:white;">Data Transaksi</td>
									</tr>
									<tr>
										<td>No Peminjaman</td>
										<td>:</td>
							...
							<div class="col-sm-7">
								<table class="table table-striped">
									<tr style="background: blue">
										<td colspan="3" style="color:white;">Pinjam Buku</td>
									</tr>
									<tr>
										<td>Kode Buku</td>
										<td>:</td>
		...
		<?php $no=1;foreach($buku->result_array() as $isi){?>
			<tr>
				...
				<button class="btn btn-primary" id="Select_File2" data_id="<?= $isi['buku_id'];?>">
					<i class="fa fa-check" style="color:black;"> </i> Pilih
				</button>
				<a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>" target="_blank">
					<button class="btn btn-success"><i class="fa fa-sign-in" style="color:black"></i> Detail</button></a>
				</td>
			</tr>
		<?php $no++;}?>
		</tbody>
